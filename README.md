...
3. **Product Grid**  
   Display all products on the home page with pagination, displaying 10 records per page.
...
5. **Login Validation (Buy Now Click)**  
   Prompt for the login if the user is not logged in.
...
9. **Login**  
   User login page. And after login home page
...
12. **Product Checkout with Stripe Form**  
...
14. **Payment Success**  
   Payment succeeded screen.
        ...
        <img width="1120" height="663" alt="image" src="https://github.com/user-attachments/assets/72941209-4631-487b-9b61-d8fbd1ca5a7c" />


16. **Payment Failed**  
   Payment failed screen.

        <img width="1120" height="665" alt="image" src="https://github.com/user-attachments/assets/ae6eec0a-09f4-4f33-9d9a-d80363abca3a" />
...
19. **Stripe Dashboard: Transactions**  
    Showing completed payments, charged products, and tracking added for products and customers.
    
        <img width="1120" height="424" alt="image" src="https://github.com/user-attachments/assets/a04da0ac-48dd-4e14-8816-3771f090bfe5" />
        
        <img width="1120" height="632" alt="image" src="https://github.com/user-attachments/assets/8fd875d1-4c01-481a-b8ed-31d62ce97154" />


20. **Stripe Product Added**  
    Product added to the Stripe dashboard.
    
        <img width="1120" height="603" alt="stripe-product-cat" src="https://github.com/user-attachments/assets/7f9ec96c-aa9d-4b64-b5b4-0d5fbfa0a7a1" />

    

22. **Stripe Customer Added**  
